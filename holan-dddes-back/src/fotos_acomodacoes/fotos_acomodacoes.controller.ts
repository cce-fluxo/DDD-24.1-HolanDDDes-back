...
export class FotosAcomodacoesController {
  constructor(private readonly fotosAcomodacoesService: FotosAcomodacoesService) {}
  ...
  @Get()
  findAll() {
    return this.fotosAcomodacoesService.findAll();
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateFotosAcomodacoeDto: UpdateFotosAcomodacoeDto) {
